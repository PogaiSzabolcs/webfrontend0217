    ...
    return(
      <View style={{flex: 1, paddingTop:20}}>
        ...
        <FlatList
          ...
          <Text style={{color:"blue",fontSize:20,textAlign:"center",marginTop:15,marginBottom:5}}   >{item.recept_kcal} kcal/adag </Text>
          <Text style={{color:"grey",fontSize:20,textAlign:"center",marginTop:15,marginBottom:5}}   >{item.recept_prot} g protein/adag </Text>
